...
public class RPNEvaluationIncDecrTestCases {
   ...
   public void valueCheck1() {
      ...
      assertEquals(String.format("%.5f", 193.9),input[0][0]);
   }
   ...
   public void valueCheck2() {
      ...
      Spreadsheet spreadsheet = new Spreadsheet(input);
      spreadsheet.evaluateSpreadSheet();
      assertEquals(String.format("%.5f", 191.9),input[0][0]);
   }

   @Test
   public void valueCheck3() {
      String input[][] = new String[1][1];
      input[0][0] = "2 3 ++ / 3 -- -2 / *";
      Spreadsheet spreadsheet = new Spreadsheet(input);
      spreadsheet.evaluateSpreadSheet();
      assertEquals(String.format("%.5f",-0.5),input[0][0]);
   }

   @Test
   public void valueCheck4() {
      String input[][] = new String[1][1];
      input[0][0] = "3 ++";
      Spreadsheet spreadsheet = new Spreadsheet(input);
      spreadsheet.evaluateSpreadSheet();
      assertEquals(String.format("%.5f",4.0),input[0][0]);
   }

   @Test
   public void rpnUnderflowExceptionTest() {
      String input[][] = new String[1][1];
      input[0][0] = "-- 3 -15 18.723 - + -52 /";
      Spreadsheet spreadsheet = new Spreadsheet(input);
      try{
         spreadsheet.evaluateSpreadSheet();
