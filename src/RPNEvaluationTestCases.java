...
public class RPNEvaluationTestCases {
   ...
   public void valueCheck1() {
      ...
      assertEquals(String.format("%.5f", -146.3),input[0][0]);
   }
   ...
   public void nullInputTest() {
      ...
      Spreadsheet spreadsheet = new Spreadsheet(input);
      spreadsheet.evaluateSpreadSheet();
      assertEquals("0.00000",input[0][0]);
   }
   ...
   @Test
   public void invalidSpacesInputTest() {
      String input[][] = new String[1][1];
      input[0][0] = "   ";
      Spreadsheet spreadsheet = new Spreadsheet(input);
      try{
         spreadsheet.evaluateSpreadSheet();
         fail("Expecting EmptyRPNException");
      } catch (EmptyRPNException e){
         String msg = "Illegal Argument " + input[0][0] + " at cell A1";
   ...
   public void invalidInputTest() {
      String input[][] = new String[1][1];
      input[0][0] = "Invalid Input";
      Spreadsheet spreadsheet = new Spreadsheet(input);
      try{
         spreadsheet.evaluateSpreadSheet();
         fail("Expecting InvalidRPNException");
      } catch (InvalidRPNException e){
         String msg = "The expression " + input[0][0] + " at cell A1 is not valid";
         assertEquals(msg, e.getMessage());
      }
   }
